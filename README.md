...
A fast heuristic algorithm for community detection in large-scale complex networks. This is a reference implementation of the algorithm proposed in: http://bdigital.unal.edu.co/69933/. This repository is integral part of the Master's thesis. We encourage you to cite this work in case you use it.
